...
$R^2$ of a least-squares line fit to the playable surface profile (a higher
value means a more linear, predictable terrain). Density metrics count solid,
...
into a single descriptive score; because leniency definitions vary in the PCG
literature, we use it here as a descriptor rather than a universal measure of
difficulty. Diversity is estimated with tile/column entropy, the unique-column
...
Reading these two figures together, a few simple patterns emerge. The
