...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
\end{lstlisting}
\caption{Opening 50~columns of Super Mario Bros World~1-1 in ASCII tilemap format.
         \texttt{M}~marks Mario's spawn; \texttt{X}~is solid ground; \texttt{S},
         \texttt{@}, \texttt{!}~are brick and question blocks; \texttt{g}~is a Goomba;
         \texttt{t}~denotes pipes; \texttt{-}~is empty air.}
...
The four weighted components below formalise these desiderata.
