/**
 * Life mushroom (1-UP) power-up sprite
 * Ported from client-java/src/main/java/arena/game/sprites/LifeMushroom.java
 */
...
export class LifeMushroom extends MarioSprite {
  ...
  clone(): MarioSprite {
    const mushroom = new LifeMushroom(false, this.x, this.y);
    mushroom.xa = this.xa;
    mushroom.ya = this.ya;
